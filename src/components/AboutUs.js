...
import "./styles/AboutUs.css"; // Optional external CSS file for styles
...
const AboutUs = () => {
  ...
  const renderContent = () => {
    switch (activeTab) {
      case "who":
        return (
          <>
            <h3>Bridging the Gap Between Veterinary Care and Convenience.</h3>
            <p>
        ...
        return (
          <>
            ...
            <ul>
              ...
              <li>Pet and Livestock Care Guidance</li>
              <li>Community-driven outreach</li>
            </ul>
          </>
        );
      default:
  ...
  return (
    ...
    <div className="about-us-container">
      ...
      {/* Welcome Section */}
      <div style={{ ...styles.wSection, position: 'relative', zIndex: 1, marginLeft: '270px' }}>
        
        
        <h2 style={styles.about}>About Us</h2>
     
      </div>
     
      <h2 style={{marginBottom:'20px', fontWeight:'bolder'}}>About Vet Connect</h2>
      ...
      <div className="about-us-content">
        ...
        <div className="about-text" style={{ marginTop: "20px", gap: "20px", fontSize: "16px", marginLeft: "20px" }}>
          <div className="tabs" style={{ marginBottom: "20px", fontWeight: "bold" }}>
            ...
            <button onClick={() => setActiveTab("who")} className={activeTab === "who" ? "active" : ""}>
              Who We Are
            </button>
            <button onClick={() => setActiveTab("mission")} className={activeTab === "mission" ? "active" : ""}>
              Our Mission
            </button>
            <button onClick={() => setActiveTab("offer")} className={activeTab === "offer" ? "active" : ""}>
              What We Offer
            </button>
          </div>
