  ...
  return (
    ...
    <div className="media-container">
      ...
      <Banner  />
        ...
        <h2 style={styles.news}>News & Articles</h2>
      </div>
      ...
      <section className="media-section">
        <div className="media-content">
          <div className="media-text">
            ...
            <h4>Symptoms of Rabies in Dogs</h4>
            <ul>
              <li><strong>Initial Symptoms (Prodromal Phase):</strong>
                <ul>
              ...
              <li><strong>Advanced Symptoms (Excitative or Furious Phase):</strong>
                <ul>
              ...
              <li><strong>Final Stage (Paralytic or Dumb Phase):</strong>
                <ul>
