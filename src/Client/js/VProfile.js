...
const VetProfile = () => {
  ...
  const handleReportSubmit = async () => {
    try {
      const response = await fetch('https://vetserver.onrender.com/reportVet', {
        method: 'POST',
        headers: {
  ...
  useEffect(() => {
    ...
    const fetchSlots = async () => {
      ...
      try {
        ...
        const dateRes = await fetch(`https://vetserver.onrender.com/availability/date/${vet._id}/${formattedDate}`, { headers });
